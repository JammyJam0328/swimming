            ...
            <main class="flex-1 relative overflow-y-auto focus:outline-none">
                <div class="py-6">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex space-x-3">
                        <h1 class="text-2xl font-semibold text-gray-900">Swimming</h1>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <?php
                                                   ...
                                                   $sql = "SELECT * FROM tbl_swimming ORDER by s_id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        ...
                                                        <span class="relative z-0 inline-flex shadow-sm rounded-md">
                                                            <button
                                                                onclick="editModal(<?php echo $row['s_id'] ?>,'<?php echo $row['title'] ?>')"
                                                                type="button"
                                                            ...
                                                            <button onclick="deleteConfirm(<?php echo $row['s_id'] ?>)"
                                                                type="button"
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="view-participants.php?id=<?php echo $row['s_id'] ?>"
