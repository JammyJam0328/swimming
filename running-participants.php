<?php         include('./db.php') ;
    ...
    $sql = "SELECT * FROM tbl_running WHERE r_id = '$request_id' limit 1";
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            <div class="relative z-10 flex-shrink-0 flex h-16 py-3 bg-white shadow">
                ...
                <div class="flex-1 px-4 flex  justify-between">
                    <a href="track-and-field.php" type="button"
            ...
            <main class="flex-1 relative overflow-y-auto focus:outline-none mb-10">
                <div class="py-6">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                                ...
                                $sql1 = "SELECT * FROM tbl_runpart WHERE r_id = '$request_id'";
                                    ...
                                    <li>
                                        <a href="#" class="block hover:bg-gray-50">
                                            <div class="flex items-center px-4 py-4 sm:px-6">
                                                <div class="min-w-0 flex-1 flex items-center">
                                                    <div class="flex-shrink-0">
                                                        <svg fill="#4a90e2" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path
                                                                d="M 34.5 3 C 32.015625 3 30 5.015625 30 7.5 C 30 9.984375 32.015625 12 34.5 12 C 36.988281 12 39 9.984375 39 7.5 C 39 5.015625 36.988281 3 34.5 3 Z M 20 10 C 19.617188 10 19.242188 10.109375 18.921875 10.316406 L 18.917969 10.316406 L 18.886719 10.324219 L 11.957031 15.296875 C 11.363281 15.65625 11 16.304688 11 17 C 11 18.105469 11.894531 19 13 19 C 13.472656 19 13.925781 18.832031 14.285156 18.527344 L 14.289063 18.53125 L 20.28125 14.21875 L 24.691406 15.621094 L 19.757813 23.660156 L 19.757813 23.664063 C 19.265625 24.34375 19 25.160156 19 26 C 19.003906 27.511719 19.859375 28.894531 21.210938 29.574219 L 28.753906 34.226563 L 27.046875 43.011719 C 27.015625 43.171875 27 43.335938 27 43.5 C 27 44.878906 28.121094 46 29.5 46 C 30.703125 46 31.734375 45.144531 31.953125 43.964844 L 31.957031 43.964844 L 33.984375 33.289063 L 33.980469 33.273438 C 33.992188 33.183594 34 33.089844 34 33 C 34 32.4375 33.761719 31.902344 33.34375 31.523438 L 33.339844 31.507813 L 27.9375 26.71875 L 32.609375 17.484375 L 32.605469 17.484375 C 32.863281 17.03125 33 16.519531 33 16 C 33 14.804688 32.289063 13.722656 31.191406 13.25 L 31.191406 13.246094 L 28.6875 11.847656 L 20.519531 10.066406 L 20.507813 10.066406 C 20.34375 10.023438 20.171875 10 20 10 Z M 34.214844 18.742188 L 31.972656 23.171875 L 33.183594 25.839844 L 33.191406 25.84375 C 33.511719 26.527344 34.199219 27 35 27 L 42 27 C 43.105469 27 44 26.105469 44 25 C 44 23.894531 43.105469 23 42 23 L 36 23 Z M 17.515625 28.414063 L 15.242188 32 L 7.5 32 C 6.117188 32 5 33.117188 5 34.5 C 5 35.882813 6.117188 37 7.5 37 L 15.933594 37 C 17.230469 37 18.445313 36.371094 19.195313 35.3125 L 21.480469 32.089844 C 20.652344 31.578125 20.054688 31.207031 20.046875 31.203125 C 18.90625 30.554688 18.03125 29.570313 17.515625 28.414063 Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                                                        <div>
                                                            <div class="flex space-x-3">
                                                                ...
                                                                <button onclick="setId(<?php echo $row['rp_id'] ?>)"
                                                                    type="button"
                                                        ...
                                                        <div class="hidden md:block">
                                                            <div>
                                                                <p class="text-sm text-gray-900">
                                                                    Time :
                                                                    <time
                                                                        datetime="2020-01-07"><?php echo $row['run_time'] ?></time>
                                                                </p>
                                                ...
                                                <div>
                                                    <button onclick="updateTimeModal(<?php echo $row['rp_id'] ?>)"
                        ...
                        <div class="mt-5">
                            <div class="pt-3 pb-5 flex justify-start">
                                <a href="report-running.php?id=<?php echo $request_id  ?>" type="button" targer="_blank"
                            ...
                            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                                <ul role="list" class="divide-y divide-gray-200">
                                    ...
                                    <?php 
                                      ...
                                      $ranking = "SELECT * , DENSE_RANK() OVER(ORDER BY run_time ASC) as rank_number FROM tbl_runpart where r_id = '$request_id' and run_time != 'Null' ";
