...
<body class="">
      ...
      -->
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            ...
            <main class="flex-1 relative overflow-y-auto focus:outline-none">
                <div class="py-6">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex space-x-3">
                        <h1 class="text-2xl font-semibold text-gray-900">Track and Field</h1>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <?php
                                                   ...
                                                   $sql = "SELECT * FROM tbl_running ORDER by r_id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        ...
                                                        <span class="relative z-0 inline-flex shadow-sm rounded-md">
                                                            <button
                                                                onclick="editModal(<?php echo $row['r_id'] ?>,'<?php echo $row['title'] ?>')"
                                                                type="button"
                                                                class="relative inline-flex items-center px-2 py-2 rounded-l-md border   text-sm font-medium  focus:z-10 focus:outline-none focus:ring-1 bg-yellow-400 text-white">
                                                                <span>Edit</span>
                                                                <!-- Heroicon name: solid/chevron-left -->

                                                            </button>
                                                            <button onclick="deleteConfirm(<?php echo $row['r_id'] ?>)"
                                                                type="button"
                                                                class="-ml-px relative inline-flex items-center px-2 py-2 rounded-r-md border   text-sm font-medium  focus:z-10 focus:outline-none focus:ring-1 bg-red-600 text-white">
                                                                <span>Delete</span>
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="running-participants.php?id=<?php echo $row['r_id'] ?>"
    ...
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div id="addModal" style="display:none" class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="mt-5 flex space-x-3">
                    ...
                    <button id="saveName" type="button"
    ...
    <!-- edit name modal -->
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div id="editNameModal" style="display:none" class="fixed z-10 inset-0 overflow-y-auto"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="mt-5 flex space-x-3">
                    ...
                    <button id="updateTitle" type="button"
                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:col-start-2 sm:text-sm">
                        Save changes
                    </button>
                </div>
    ...
    <script>
    function editModal(edit_id, name) {
        $('#editNameModal').show();
        $('#edit_id').val(edit_id);
        $('#newTitle').val(name);
    }
    ...
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        $(document).on('click', '#openAddModal', function(e) {
            e.preventDefault();
            $('#addModal').show()
        });
